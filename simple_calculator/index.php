			...
			<div class="starter-template">
				<div class="page-header">
					<?php include_once("global/header.php"); ?>	
							...
							<p class="text-left">
					<strong>Performs:</strong>
					<ul>
					<li class="text-left">Addition</li>
						<li class="text-left">Subtraction</li>
						<li class="text-left">Multiplication</li>
						<li class="text-left">Division</li>
						<li class="text-left">Exponentiation</li>
					</p>
					...
					<form method="post" role="form" class="form-horizontal" action="process.php">
